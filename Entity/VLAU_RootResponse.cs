...
namespace Entity
{
    ...
    public class VLAU_DetalleResponse
    {
    ...
    public class VLAU_ListadoDetalle
    {
        public List<VLAU_DetalleResponse> detalle
        {
            get { return m_detalle; }
            set { m_detalle = value; }
        }
        private List<VLAU_DetalleResponse> m_detalle;

    }


    public class VLAU_IntegrationResponse
    {
        ...
        public VLAU_ListadoDetalle listadoDetalle
        {
            get { return m_listadoDetalle; }
            set { m_listadoDetalle = value; }
        }
        private VLAU_ListadoDetalle m_listadoDetalle;
        ...
        public int nro_orden_sgte
        {
            get { return m_nro_orden_sgte; }
            set { m_nro_orden_sgte = value; }
        }
        private int m_nro_orden_sgte;
    ...
    public class VLAU_XMLNSCResponse
    {
        public VLAU_IntegrationResponse integrationResponse
        {
            get { return m_integrationResponse; }
            set { m_integrationResponse = value; }
        }
        private VLAU_IntegrationResponse m_integrationResponse;

    }


    public class VLAU_RootResponse
    {
        public VLAU_XMLNSCResponse XMLNSC
        {
            get { return m_XMLNSC; }
            set { m_XMLNSC = value; }
        }
        private VLAU_XMLNSCResponse m_XMLNSC;
