...
namespace Entity
{
    public class VLAO_DetalleResponse
    {
    ...
    public class VLAO_ListadoDetalle
    {
        public List<VLAO_DetalleResponse> detalle
        {
            get { return m_detalle; }
            set { m_detalle = value; }
        }
        private List<VLAO_DetalleResponse> m_detalle;

    }


    public class VLAO_IntegrationResponse
    {
        ...
        public VLAO_ListadoDetalle listadoDetalle
        {
            get { return m_listadoDetalle; }
            set { m_listadoDetalle = value; }
        }
        private VLAO_ListadoDetalle m_listadoDetalle;
    ...
    public class VLAO_XMLNSCResponse
    {
        public VLAO_IntegrationResponse integrationResponse
        {
            get { return m_integrationResponse; }
            set { m_integrationResponse = value; }
        }
        private VLAO_IntegrationResponse m_integrationResponse;

    }


    public class VLAO_RootResponse
    {
        public VLAO_XMLNSCResponse XMLNSC
        {
            get { return m_XMLNSC; }
            set { m_XMLNSC = value; }
        }
        private VLAO_XMLNSCResponse m_XMLNSC;
