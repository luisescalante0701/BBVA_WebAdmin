...
namespace Entity
{
    ...
    public class VLAK_DetalleResponse
    {
    ...
    public class VLAK_ListadoDetalle
    {
        public List<VLAK_DetalleResponse> detalle
        {
            get { return m_detalle; }
            set { m_detalle = value; }
        }
        private List<VLAK_DetalleResponse> m_detalle;

    }


    public class VLAK_IntegrationResponse
    {
        ...
        public VLAK_ListadoDetalle listadoDetalle
        {
            get { return m_listadoDetalle; }
            set { m_listadoDetalle = value; }
        }
        private VLAK_ListadoDetalle m_listadoDetalle;
    ...
    public class VLAK_XMLNSCResponse
    {
        public VLAK_IntegrationResponse integrationResponse
        {
            get { return m_integrationResponse; }
            set { m_integrationResponse = value; }
        }
        private VLAK_IntegrationResponse m_integrationResponse;

    }


    public class VLAK_RootResponse
    {
        public VLAK_XMLNSCResponse XMLNSC
        {
            get { return m_XMLNSC; }
            set { m_XMLNSC = value; }
        }
        private VLAK_XMLNSCResponse m_XMLNSC;
