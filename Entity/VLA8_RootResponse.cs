...
namespace Entity
{
    ...
    public class VLA8_DetalleResponse
    {
    ...
    public class VLA8_ListadoDetalle
    {
    ...
    public class VLA8_IntegrationResponse
    {
        ...
        public string cta_eco_abono
        {
            get { return m_cta_eco_abono; }
            set { m_cta_eco_abono = value; }
        }
        private string m_cta_eco_abono;

        public string mon_eco_abono
        {
            get { return m_mon_eco_abono; }
            set { m_mon_eco_abono = value; }
        }
        private string m_mon_eco_abono;
    ...
    public class VLA8_XMLNSCResponse
    {
        public VLA8_IntegrationResponse integrationResponse
        {
            get { return m_integrationResponse; }
            set { m_integrationResponse = value; }
        }
        private VLA8_IntegrationResponse m_integrationResponse;

    }


    public class VLA8_RootResponse
    {
        public VLA8_XMLNSCResponse XMLNSC
        {
            get { return m_XMLNSC; }
            set { m_XMLNSC = value; }
        }
        private VLA8_XMLNSCResponse m_XMLNSC;
