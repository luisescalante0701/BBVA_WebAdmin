...
namespace Entity
{
    ...
    public class VLAA_DetalleResponse
    {
    ...
    public class VLAA_ListadoDetalle
    {
        public List<VLAA_DetalleResponse> detalle
        {
            get { return m_detalle; }
            set { m_detalle = value; }
        }
        private List<VLAA_DetalleResponse> m_detalle;

    }


    public class VLAA_IntegrationResponse
    {
        ...
        public VLAA_ListadoDetalle listadoDetalle
        {
            get { return m_listadoDetalle; }
            set { m_listadoDetalle = value; }
        }
        private VLAA_ListadoDetalle m_listadoDetalle;
    ...
    public class VLAA_XMLNSCResponse
    {
        public VLAA_IntegrationResponse integrationResponse
        {
            get { return m_integrationResponse; }
            set { m_integrationResponse = value; }
        }
        private VLAA_IntegrationResponse m_integrationResponse;

    }


    public class VLAA_RootResponse
    {
        public VLAA_XMLNSCResponse XMLNSC
        {
            get { return m_XMLNSC; }
            set { m_XMLNSC = value; }
        }
        private VLAA_XMLNSCResponse m_XMLNSC;
